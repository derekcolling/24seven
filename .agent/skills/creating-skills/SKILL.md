...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use when the user asks to create a new skill or defining a reusable workflow.
---
...
- When the user explicitly asks to "create a skill" or "make a skill".
- When you identify a repeatable complex task that should be standardized (proactively suggest this).
...
When asked to create a skill, use the proper tools to create the files directly. If you must output text, use this format:
